...
type Constructors = BooleanConstructor | StringConstructor | NumberConstructor | FunctionConstructor | ObjectConstructor | ArrayBufferConstructor | PromiseConstructor;

/**
 * 万能类型，适合所有复杂场景
 * @param types 类型构造函数集合
 * @param defaultVal 默认值
 * @returns
 */
export function almightyProps<T>(types: Constructors | Constructors[], defaultVal?: any) {
  return {
